...
echo '
    ...
    <picture>
        <source type="image/webp" srcset="images/section3/email.webp">
        <img loading="lazy" src="images/section3/email.png" height="150px" alt="Photo email for business">
    </picture>
...
<div class="gallery-cell">
    ...
    <picture>
        <source type="image/webp" srcset="images/section3/padlock.webp">
        <img loading="lazy" src="images/section3/padlock.png" height="150px" alt="Photo of a padlock for great security using SSL">
    </picture>
...
<div class="gallery-cell">
    ...
    <picture>
        <source type="image/webp" srcset="images/section3/analytics.webp">
        <img loading="lazy" src="images/section3/analytics.png" height="150px" alt="Chart showing growing views using Google Analytics">
    </picture>
...
<div class="gallery-cell">
    ...
    <picture>
        <source type="image/webp" srcset="images/section3/browser.webp">
        <img loading="lazy" height="150px" src="images/section3/browser.png" alt="Photo of a clock and browser representing fast UK hosting">
    </picture>
...
<div class="gallery-cell">
    ...
    <picture>
        <source type="image/webp" srcset="images/section3/seo.webp">
        <img src="images/section3/seo.png" height="150px" alt="Photo of best SEO possible" loading="lazy">
    </picture>
...
<div class="gallery-cell">
    ...
    <picture>
        <source type="image/webp" srcset="images/section3/networking2.webp">
        <img src="images/section3/networking2.png" height="150px" alt="Social media, networking" loading="lazy">
    </picture>
...
<div class="gallery-cell">
    ...
    <picture>
        <source type="image/webp" srcset="images/section3/interactive.webp">
        <img src="images/section3/interactive.png" height="150px" alt="Photo of immersive effect, Halesowen" loading="lazy">
    </picture>
...
<div class="gallery-cell">
    ...
    <picture>
        <source type="image/webp" srcset="images/section3/responsive2.webp">
        <img src="images/section3/responsive2.png" height="150px" alt="Responsive desing" loading="lazy">
    </picture>
