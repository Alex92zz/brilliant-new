    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
            <div class="paragraph">
                ...
                <img class="lazy module" src="images/section4/responsivedesign.png" alt="Responsive web design Halesowen" loading="lazy">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
            <div class="paragraph" id="seo">
                ...
                <img class="lazy module" src="images/section4/google-seo.png" alt="SEO Halesowen" loading="lazy">
